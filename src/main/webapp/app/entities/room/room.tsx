      ...
      <div className="table-responsive">
        {roomList?.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('roomNumber')}>
                  Room Number <FontAwesomeIcon icon={getSortIconByFieldName('roomNumber')} />
                </th>
                ...
                <th className="hand" onClick={sort('pricePerNight')}>
                  Price Per Night <FontAwesomeIcon icon={getSortIconByFieldName('pricePerNight')} />
                </th>
                ...
                <th className="hand" onClick={sort('amenities')}>
                  Amenities <FontAwesomeIcon icon={getSortIconByFieldName('amenities')} />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {roomList.map(room => (
                <tr key={`entity-${room.id}`} data-cy="entityTable">
                  <td>
                    <Button as={Link as any} to={`/room/${room.id}`} variant="link" size="sm">
                      {room.id}
                    </Button>
                  </td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button as={Link as any} to={`/room/${room.id}`} variant="info" size="sm" data-cy="entityDetailsButton">
                      ...
                      <Button
                        onClick={() =>
                          (globalThis.location.href = `/room/${room.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        variant="danger"
                        size="sm"
