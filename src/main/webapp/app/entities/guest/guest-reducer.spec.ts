...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './guest.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GUEST actions', async () => {
      const arg = { id: 928 };
    ...
    it('dispatches UPDATE_GUEST actions', async () => {
      const arg = { id: 928 };
    ...
    it('dispatches PARTIAL_UPDATE_GUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GUEST actions', async () => {
      const arg = 42666;
