...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './room.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROOM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROOM actions', async () => {
      const arg = { id: 22394 };
    ...
    it('dispatches UPDATE_ROOM actions', async () => {
      const arg = { id: 22394 };
    ...
    it('dispatches PARTIAL_UPDATE_ROOM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ROOM actions', async () => {
      const arg = 42666;
