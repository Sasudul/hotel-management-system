...
class PaymentResourceIT {
    ...
    private static final PaymentMethod UPDATED_METHOD = PaymentMethod.CARD_AT_HOTEL;
    ...
    private static final Instant UPDATED_PAID_DATE = Instant.ofEpochMilli(1787912193534L);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.status(UPDATED_STATUS).paidDate(UPDATED_PAID_DATE).notes(UPDATED_NOTES);
