...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './booking.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKING actions', async () => {
      const arg = { id: 4697 };
    ...
    it('dispatches UPDATE_BOOKING actions', async () => {
      const arg = { id: 4697 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKING actions', async () => {
      const arg = 42666;
